...
import Contact from "../conponents/Contact"; // Fixed path
import mapImage from "../assets copy/Image-folder/map.png"; // Ensure correct path
...
const ContactUs = () => { // Capitalized component name
  return (
    <div className="mt-24">
      ...
      >
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <motion.div className="flex justify-center mt-10 items-center" variants={fadeIn}>
            <img
              src={mapImage} // Fixed Image Import
...
export default ContactUs; // Fixed component name
