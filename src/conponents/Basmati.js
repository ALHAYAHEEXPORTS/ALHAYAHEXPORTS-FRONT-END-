...
const RiceCategories = () => {
  return (
    <div className="min-h-screen mt-24 flex flex-col items-center justify-center p-4 sm:p-6">
      {/* Main Image */}
      <motion.img
        src={riceImg}
        alt="Different Types of Rice"
        className="w-full max-w-2xl sm:max-w-3xl shadow-lg rounded-lg mb-6 sm:mb-8"
      ...
      {/* Title */}
      <motion.h1
        className="text-2xl sm:text-4xl font-bold text-gray-800 mb-4 sm:mb-6 text-center"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      <div className="max-w-xl sm:max-w-3xl w-full space-y-6 sm:space-y-10">
        ...
        >
          <h2 className="text-xl sm:text-2xl font-semibold text-gray-800 mb-2 sm:mb-3">Basmati Rice</h2>
        ...
        >
          <h2 className="text-xl sm:text-2xl font-semibold text-gray-800 mb-2 sm:mb-3">Non-Basmati Rice</h2>
          <p className="text-gray-700 mb-3 sm:mb-4">
        ...
        >
          <h2 className="text-xl sm:text-2xl font-semibold text-gray-800 mb-2 sm:mb-3">Popular Non-Basmati Varieties</h2>
          <ul className="list-disc pl-5 text-gray-600 text-sm sm:text-base">
        ...
        >
          <h2 className="text-xl sm:text-2xl font-semibold text-gray-800 mb-2 sm:mb-3">Pesticide-Free Rice</h2>
          <p className="text-gray-700 mb-3 sm:mb-4">
        ...
        >
          <h2 className="text-xl sm:text-2xl font-semibold text-gray-800 mb-2 sm:mb-3">Health Benefits</h2>
          <ul className="list-disc pl-5 text-gray-600 text-sm sm:text-base">
        ...
        >
          <h2 className="text-xl sm:text-2xl font-semibold text-gray-800 mb-2 sm:mb-3">Storage Tips</h2>
