...
const WorkingProcess = () => {
  ...
  return (
    <div className="p-4 sm:p-6 md:p-8 bg-gradient-to-b from-[#f4f4f8] to-white text-gray-800">
      {/* Heading Section */}
      <motion.div
      ...
      >
        ...
        />
        <h2 className="text-lg sm:text-2xl md:text-3xl lg:text-4xl font-extrabold text-center text-[#4B4E6D]">
          Our Working Process
        </h2>
      </motion.div>
      <motion.p
