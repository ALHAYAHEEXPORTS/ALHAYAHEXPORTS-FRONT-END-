...
const fadeInUp = {
  ...
  visible: { opacity: 1, y: 0, transition: { duration: .8, ease: "easeInOut" } },
};
...
const HomePage = () => {
  ...
  return (
    <div>
      {/* Hero Section */}
      <motion.header
        className="mt-24 sm:mt-28 relative w-full bg-cover bg-center py-12 sm:py-16"
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center relative space-y-6 md:space-y-0">
          {/* Left Section */}
          <motion.div
            className="text-center md:text-left md:w-1/2 bg-white bg-opacity-90 p-4 sm:p-6 md:p-8 rounded-lg shadow-lg"
            variants={fadeInLeft}
          >
            <h1 className="text-xl sm:text-3xl lg:text-4xl font-bold text-gray-800 mb-4 sm:mb-6 leading-snug">
            ...
            <div className="flex flex-wrap justify-center md:justify-start gap-4">
              ...
              <motion.button
                className="bg-yellow-900 text-white px-3 sm:px-6 py-2 sm:py-3 rounded-lg shadow-md hover:bg-yellow-900"
              ...
              <motion.div>
      <motion.button
        className="bg-transparent border border-yellow-900 text-yellow-900 px-3 sm:px-6 py-2 sm:py-3 rounded-lg shadow-md hover:bg-yellow-800 hover:text-white"
        whileHover={{ scale: 1.05 }}
        transition={{ duration: 0.5 }}
