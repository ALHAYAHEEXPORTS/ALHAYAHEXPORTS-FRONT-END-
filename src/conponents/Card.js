...
const Card = () => {
  ...
  return (
    <motion.div
      className="p-4 sm:p-8 bg-gradient-to-b from-[#f4f4f8] to-white text-gray-800"
      initial="hidden"
      whileInView="visible"
    ...
    >
      {/* Heading Section */}
      <motion.div
        className="flex flex-col sm:flex-row justify-center items-center gap-3 mb-4 text-center"
        variants={fadeInUp}
      >
        <img
        ...
        />
        <h2 className="text-2xl sm:text-3xl font-extrabold text-[#4B4E6D]">Our Products</h2>
      </motion.div>

      {/* Introductory Text */}
      <motion.p
        className="text-base sm:text-lg text-gray-600 mb-6 text-center"
        variants={fadeInUp}
      >
      ...
      <motion.div className="text-center mt-6 sm:mt-8" variants={fadeInUp}>
        <motion.button
          onClick={() => navigate("/product")}
          className="bg-[#695a38d5] text-white font-semibold py-2 px-4 sm:py-3 sm:px-6 rounded-lg shadow-lg hover:bg-[#6c5d47b9] transition transform hover:scale-105 mb-8 sm:mb-11 mt-8 sm:mt-11"
